...
public class StringEncryptionTools {
    ...
    private void init() throws Exception {
        KeyGenerator keygenerator = KeyGenerator.getInstance(Helper.Const.ENCRYPTION_ALGORITHM_NAME);
        SecretKey secretkey = keygenerator.generateKey();

        key = new SecretKeySpec(secretkey.getEncoded(), Helper.Const.ENCRYPTION_ALGORITHM_NAME);
        cipher = Cipher.getInstance(Helper.Const.ENCRYPTION_ALGORITHM_NAME);
    }
